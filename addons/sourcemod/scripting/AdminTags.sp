...
public int HandleTag(int client)
{
	...
	{
		char tagsT[255], tagsCT[255], tagsMOD[255], tagsADM[255], tagsHADM[255], tagsCADM[255];
		...
		else if (GetUserFlagBits(client) & ADMFLAG_RCON)
		{
		...
		{
			Format(tagsMOD, sizeof(tagsMOD), "%t" ,"tags_MOD", LANG_SERVER);
			CS_SetClientClanTag(client, tagsMOD); 
		}
